...
class NRRDReader(IReader):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Unknown = _pyglass.NRRDReader_Unknown
    RAW = _pyglass.NRRDReader_RAW
    TXT = _pyglass.NRRDReader_TXT
    HEX = _pyglass.NRRDReader_HEX
    GZIP = _pyglass.NRRDReader_GZIP
    BZIP2 = _pyglass.NRRDReader_BZIP2
    Other = _pyglass.NRRDReader_Other
    X = _pyglass.NRRDReader_X
    Y = _pyglass.NRRDReader_Y
    Z = _pyglass.NRRDReader_Z
    C = _pyglass.NRRDReader_C
    T = _pyglass.NRRDReader_T
    AxisCount = _pyglass.NRRDReader_AxisCount

    def __init__(self):
        _pyglass.NRRDReader_swiginit(self, _pyglass.new_NRRDReader())
    __swig_destroy__ = _pyglass.delete_NRRDReader

    def OpenFile(self, path: "std::string const &", isTimeSeries: "bool") -> "bool":
        return _pyglass.NRRDReader_OpenFile(self, path, isTimeSeries)

    def ReadBlock(self, start: "ivec3", size: "ivec3", timepoint: "int") -> "Raster":
        return _pyglass.NRRDReader_ReadBlock(self, start, size, timepoint)

    def GetSize(self) -> "glm::ivec3":
        return _pyglass.NRRDReader_GetSize(self)

    def GetFrameCount(self) -> "int":
        return _pyglass.NRRDReader_GetFrameCount(self)

    def GetDataType(self) -> "ProjectIO::DataType":
        return _pyglass.NRRDReader_GetDataType(self)

    def GetChannelsCount(self) -> "ProjectIO::Channels":
        return _pyglass.NRRDReader_GetChannelsCount(self)

    def HasSupportOfArbitraryReads(self) -> "bool":
        return _pyglass.NRRDReader_HasSupportOfArbitraryReads(self)

    def GetVoxelDimensions(self) -> "glm::vec3":
        return _pyglass.NRRDReader_GetVoxelDimensions(self)

    def GetVoxelUnit(self) -> "std::string":
        return _pyglass.NRRDReader_GetVoxelUnit(self)

# Register NRRDReader in _pyglass:
_pyglass.NRRDReader_swigregister(NRRDReader)


def OpenNRRD(path: "std::string", isTimeSeries: "bool") -> "DataProvider":
    return _pyglass.OpenNRRD(path, isTimeSeries)
...
class ZarrReader(IReader):
    ...
    def OpenFile(self, *args) -> "bool":
        return _pyglass.ZarrReader_OpenFile(self, *args)

    def OpenFileDeprecated(self, path: "std::string const &") -> "bool":
        return _pyglass.ZarrReader_OpenFileDeprecated(self, path)

    def DoesFileExist(self, *args) -> "bool":
        return _pyglass.ZarrReader_DoesFileExist(self, *args)

    def ReadBlock(self, *args) -> "Raster":
        return _pyglass.ZarrReader_ReadBlock(self, *args)

    def GetResolutionLayersCount(self) -> "int":
        return _pyglass.ZarrReader_GetResolutionLayersCount(self)
    ...
    def GetTreeK(self) -> "int":
        return _pyglass.ZarrReader_GetTreeK(self)

    def GetZarrVersion(self) -> "int":
        return _pyglass.ZarrReader_GetZarrVersion(self)

    def GetStoreType(self) -> "Zarr::StoreType":
        return _pyglass.ZarrReader_GetStoreType(self)

    def GetLocalPath(self) -> "fs::path":
        return _pyglass.ZarrReader_GetLocalPath(self)

    def GetLocalCacheSize(self) -> "unsigned long long":
        return _pyglass.ZarrReader_GetLocalCacheSize(self)

    def SetLocalCacheLimit(self, bytes: "unsigned long long") -> "void":
        return _pyglass.ZarrReader_SetLocalCacheLimit(self, bytes)

    def GetLocalCacheLimit(self) -> "unsigned long long":
        return _pyglass.ZarrReader_GetLocalCacheLimit(self)

    def ClearLocalCache(self) -> "void":
        return _pyglass.ZarrReader_ClearLocalCache(self)
...
def OpenZarrStore(path: "std::string") -> "DataProvider":
    return _pyglass.OpenZarrStore(path)
...
class DirectoryDescription(object):
    ...
    MRC = _pyglass.DirectoryDescription_MRC
    TCF = _pyglass.DirectoryDescription_TCF
    NRRD = _pyglass.DirectoryDescription_NRRD
...
class NarrationFileWriter(object):
    ...
    @staticmethod
    def WriteFileHandle(memoryFile: "FileHandle", dstPath: "path") -> "void":
        return _pyglass.NarrationFileWriter_WriteFileHandle(memoryFile, dstPath)
...
def NarrationFileWriter_WriteFileHandle(memoryFile: "FileHandle", dstPath: "path") -> "void":
    return _pyglass.NarrationFileWriter_WriteFileHandle(memoryFile, dstPath)
...
class LearningModule(object):
    ...
    def IsCompleted(self) -> "bool":
        return _pyglass.LearningModule_IsCompleted(self)
...
STANDARD = _pyglass.STANDARD
IMARIS = _pyglass.IMARIS
OME_ZARR = _pyglass.OME_ZARR
INVALID_PROJECT = _pyglass.INVALID_PROJECT

def IsAProjectFile(*args) -> "bool":
    return _pyglass.IsAProjectFile(*args)

def GetProjectType(path: "path") -> "ProjectIO::ProjectType":
    return _pyglass.GetProjectType(path)
...
class Project(object):
    ...
    @staticmethod
    def CreateZarr() -> "ProjectIO::Project":
        return _pyglass.Project_CreateZarr()
    ...
    def SetIncludedChannels(self, includedChannels: "IntList") -> "void":
        return _pyglass.Project_SetIncludedChannels(self, includedChannels)
    ...
    def UpdateMaskColorMap(self, dir: "std::string const &", IDs: "UShortList", values: "ByteList", No: "uint8_t"=1) -> "void":
        return _pyglass.Project_UpdateMaskColorMap(self, dir, IDs, values, No)

    def GetMaskIdColorMap(self, dir: "std::string const &", IDs: "UShortList", No: "uint8_t"=1) -> "std::map< uint16_t,int,std::less< uint16_t >,std::allocator< std::pair< uint16_t const,int > > >":
    ...
    def ResetMaskNames(self, dir: "std::string const &", IDs: "UShortList") -> "void":
        return _pyglass.Project_ResetMaskNames(self, dir, IDs)

    def GetMaskNamesByIDs(self, dir: "std::string const &", IDs: "UShortList") -> "std::vector< std::string,std::allocator< std::string > >":
    ...
    def ExportMaskSettingsCSV(self, dir: "std::string const &", IDs: "UShortList", path: "std::string const &") -> "bool":
...
def Project_CreateZarr() -> "ProjectIO::Project":
    return _pyglass.Project_CreateZarr()
...
class Raster(object):
    ...
    @staticmethod
    def IsIntegerType(d: "Raster::DataType") -> "bool":
        return _pyglass.Raster_IsIntegerType(d)
...
def Raster_IsIntegerType(d: "Raster::DataType") -> "bool":
    return _pyglass.Raster_IsIntegerType(d)
...
class ConnectionSettings(object):
    ...
    m_verbose = property(_pyglass.ConnectionSettings_m_verbose_get, _pyglass.ConnectionSettings_m_verbose_set)
...
class FileHandle(object):
    ...
    def ReadLine(self, *args) -> "void":
        return _pyglass.FileHandle_ReadLine(self, *args)
...
class UShortList(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self) -> "swig::SwigPyIterator *":
        return _pyglass.UShortList_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self) -> "bool":
        return _pyglass.UShortList___nonzero__(self)

    def __bool__(self) -> "bool":
        return _pyglass.UShortList___bool__(self)

    def __len__(self) -> "std::vector< unsigned short >::size_type":
        return _pyglass.UShortList___len__(self)
    ...
    def __getslice__(self, i: "std::vector< unsigned short >::difference_type", j: "std::vector< unsigned short >::difference_type") -> "std::vector< unsigned short,std::allocator< unsigned short > > *":
        return _pyglass.UShortList___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _pyglass.UShortList___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< unsigned short >::difference_type", j: "std::vector< unsigned short >::difference_type") -> "void":
        return _pyglass.UShortList___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _pyglass.UShortList___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< unsigned short >::value_type const &":
        return _pyglass.UShortList___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _pyglass.UShortList___setitem__(self, *args)

    def pop(self) -> "std::vector< unsigned short >::value_type":
        return _pyglass.UShortList_pop(self)

    def append(self, x: "std::vector< unsigned short >::value_type const &") -> "void":
        return _pyglass.UShortList_append(self, x)

    def empty(self) -> "bool":
        return _pyglass.UShortList_empty(self)

    def size(self) -> "std::vector< unsigned short >::size_type":
        return _pyglass.UShortList_size(self)

    def swap(self, v: "UShortList") -> "void":
        return _pyglass.UShortList_swap(self, v)

    def begin(self) -> "std::vector< unsigned short >::iterator":
        return _pyglass.UShortList_begin(self)

    def end(self) -> "std::vector< unsigned short >::iterator":
        return _pyglass.UShortList_end(self)

    def rbegin(self) -> "std::vector< unsigned short >::reverse_iterator":
        return _pyglass.UShortList_rbegin(self)

    def rend(self) -> "std::vector< unsigned short >::reverse_iterator":
        return _pyglass.UShortList_rend(self)

    def clear(self) -> "void":
        return _pyglass.UShortList_clear(self)

    def get_allocator(self) -> "std::vector< unsigned short >::allocator_type":
        return _pyglass.UShortList_get_allocator(self)

    def pop_back(self) -> "void":
        return _pyglass.UShortList_pop_back(self)

    def erase(self, *args) -> "std::vector< unsigned short >::iterator":
        return _pyglass.UShortList_erase(self, *args)

    def __init__(self, *args):
        _pyglass.UShortList_swiginit(self, _pyglass.new_UShortList(*args))

    def push_back(self, x: "std::vector< unsigned short >::value_type const &") -> "void":
        return _pyglass.UShortList_push_back(self, x)

    def front(self) -> "std::vector< unsigned short >::value_type const &":
        return _pyglass.UShortList_front(self)

    def back(self) -> "std::vector< unsigned short >::value_type const &":
        return _pyglass.UShortList_back(self)

    def assign(self, n: "std::vector< unsigned short >::size_type", x: "std::vector< unsigned short >::value_type const &") -> "void":
        return _pyglass.UShortList_assign(self, n, x)

    def resize(self, *args) -> "void":
        return _pyglass.UShortList_resize(self, *args)

    def insert(self, *args) -> "void":
        return _pyglass.UShortList_insert(self, *args)

    def reserve(self, n: "std::vector< unsigned short >::size_type") -> "void":
        return _pyglass.UShortList_reserve(self, n)

    def capacity(self) -> "std::vector< unsigned short >::size_type":
        return _pyglass.UShortList_capacity(self)
    __swig_destroy__ = _pyglass.delete_UShortList

# Register UShortList in _pyglass:
_pyglass.UShortList_swigregister(UShortList)
...
class UShortIntMap(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self) -> "swig::SwigPyIterator *":
        return _pyglass.UShortIntMap_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self) -> "bool":
        return _pyglass.UShortIntMap___nonzero__(self)

    def __bool__(self) -> "bool":
        return _pyglass.UShortIntMap___bool__(self)

    def __len__(self) -> "std::map< unsigned short,int >::size_type":
        return _pyglass.UShortIntMap___len__(self)
    def __iter__(self):
        return self.key_iterator()
    def iterkeys(self):
        return self.key_iterator()
    ...
    def __getitem__(self, key: "std::map< unsigned short,int >::key_type const &") -> "std::map< unsigned short,int >::mapped_type const &":
        return _pyglass.UShortIntMap___getitem__(self, key)

    def __delitem__(self, key: "std::map< unsigned short,int >::key_type const &") -> "void":
        return _pyglass.UShortIntMap___delitem__(self, key)

    def has_key(self, key: "std::map< unsigned short,int >::key_type const &") -> "bool":
        return _pyglass.UShortIntMap_has_key(self, key)

    def keys(self) -> "PyObject *":
        return _pyglass.UShortIntMap_keys(self)

    def values(self) -> "PyObject *":
        return _pyglass.UShortIntMap_values(self)

    def items(self) -> "PyObject *":
        return _pyglass.UShortIntMap_items(self)

    def __contains__(self, key: "std::map< unsigned short,int >::key_type const &") -> "bool":
        return _pyglass.UShortIntMap___contains__(self, key)

    def key_iterator(self) -> "swig::SwigPyIterator *":
        return _pyglass.UShortIntMap_key_iterator(self)

    def value_iterator(self) -> "swig::SwigPyIterator *":
        return _pyglass.UShortIntMap_value_iterator(self)

    def __setitem__(self, *args) -> "void":
        return _pyglass.UShortIntMap___setitem__(self, *args)

    def asdict(self) -> "PyObject *":
        return _pyglass.UShortIntMap_asdict(self)

    def __init__(self, *args):
        _pyglass.UShortIntMap_swiginit(self, _pyglass.new_UShortIntMap(*args))

    def empty(self) -> "bool":
        return _pyglass.UShortIntMap_empty(self)

    def size(self) -> "std::map< unsigned short,int >::size_type":
        return _pyglass.UShortIntMap_size(self)

    def swap(self, v: "UShortIntMap") -> "void":
        return _pyglass.UShortIntMap_swap(self, v)

    def begin(self) -> "std::map< unsigned short,int >::iterator":
        return _pyglass.UShortIntMap_begin(self)

    def end(self) -> "std::map< unsigned short,int >::iterator":
        return _pyglass.UShortIntMap_end(self)

    def rbegin(self) -> "std::map< unsigned short,int >::reverse_iterator":
        return _pyglass.UShortIntMap_rbegin(self)

    def rend(self) -> "std::map< unsigned short,int >::reverse_iterator":
        return _pyglass.UShortIntMap_rend(self)

    def clear(self) -> "void":
        return _pyglass.UShortIntMap_clear(self)

    def get_allocator(self) -> "std::map< unsigned short,int >::allocator_type":
        return _pyglass.UShortIntMap_get_allocator(self)

    def count(self, x: "std::map< unsigned short,int >::key_type const &") -> "std::map< unsigned short,int >::size_type":
        return _pyglass.UShortIntMap_count(self, x)

    def erase(self, *args) -> "void":
        return _pyglass.UShortIntMap_erase(self, *args)

    def find(self, x: "std::map< unsigned short,int >::key_type const &") -> "std::map< unsigned short,int >::iterator":
        return _pyglass.UShortIntMap_find(self, x)

    def lower_bound(self, x: "std::map< unsigned short,int >::key_type const &") -> "std::map< unsigned short,int >::iterator":
        return _pyglass.UShortIntMap_lower_bound(self, x)

    def upper_bound(self, x: "std::map< unsigned short,int >::key_type const &") -> "std::map< unsigned short,int >::iterator":
        return _pyglass.UShortIntMap_upper_bound(self, x)
    __swig_destroy__ = _pyglass.delete_UShortIntMap

# Register UShortIntMap in _pyglass:
_pyglass.UShortIntMap_swigregister(UShortIntMap)
